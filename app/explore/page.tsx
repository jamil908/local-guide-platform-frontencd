...
import ExploreClient from './ExploreCLient';  // Import the client component
import { LoadingSpinner } from '@/components/shared/Loading'; 

// Define a loading component for the fallback
const LoadingFallback = () => (
    <div className="min-h-screen bg-gray-900 text-gray-100 flex items-center justify-center">
        {/* Use your spinner component here */}
        <LoadingSpinner size="lg" color="text-amber-500" />
    </div>
);

// This is the default Server Component export for the /explore route
export default function ExplorePage() {
    return (
        // The Suspense boundary prevents the server from attempting to render 
        // ExploreClient and its useSearchParams() hook during the build.
