...
// A simple fallback component for the loading state (optional, but good practice)
const LoadingFallback = () => (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center text-gray-700">
        Loading payment details...
        {/* You could add your LoadingSpinner here */}
        {/* <LoadingSpinner size="lg" /> */}
    </div>
);

// This is the default Server Component for the /payment/failed route
export default function PaymentFailedPageWrapper() {
    return (
        // The Suspense boundary is the crucial fix for the useSearchParams error.
